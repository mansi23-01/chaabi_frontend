  ...
  return (
    <div className="main">
      ...
      {!practiceStarted && !showResults && (
        <div>
          <h2 className="heading2">Improve your <span>typing speed</span> online!!!</h2>
          <p className="para">
            It is a free touch typing courseware running directly in your
            browser. It assists you to practice your keyboard skills efficiently
            and therefore increase your typing speed immensely.
          </p>
      ...
      {showResults && (
        <div className="results-popup">
          ...
          <p className="typing">Typing Speed: {typingSpeed} words per minute</p>
